var $=jQuery.noConflict();let tooltip=$("#map__tooltip");function show_map_info(t){let e=t,i=e.offset().left,s=e.offset().top,n=e.closest(".active");$(window).width()>991&&tooltip.css({left:i,top:s-100}),$("#tooltip_title").html(e.data("name")),$("#tooltip_content").html(e.data("content")),$("#tooltip_url").attr("href",e.data("url")),$("#tooltip_url2").attr("href",e.data("url")),$("#tooltip_image").attr("src",e.data("image")),$(".map .active").not(n).removeClass("selected"),tooltip.addClass("open"),n.addClass("selected")}function onTidioChatApiReady(){window.tidioChatApi.hide(),window.tidioChatApi.on("close",(function(){window.tidioChatApi.hide(),$(".chat-bot").show()}))}function getDate(t){var e;try{e=$.datepicker.parseDate(dateFormat,t.value)}catch(t){e=null}return e}function initJqueryUI(){$(".accordion").accordion({active:!1,collapsible:!0,header:".opener",heightStyle:"content"}),$(".booking-tabs").tabs(),$(document).on("click",".custom-tabs a:not(.external-link)",(function(t){t.preventDefault();var e=$(this),i=e.closest(".custom-tabs"),s=$(".tabs-holder",i),n=e.attr("href");$(".tab.display",s).removeClass("display"),e.closest("ul").find(".active").removeClass("active"),$(n).addClass("display"),e.parent().addClass("active")}))}
...
* Copyright jQuery Foundation and other contributors; Licensed MIT */function initSlick(){if($(".banners").length)$(".banners").slick({autoplay:!0,nextArrow:!1,prevArrow:!1,autoplaySpeed:4e3,dots:!0});$(".intro_sliders").length&&$(".intro_sliders").each((function(t,e){if($(e).children().length<=1)return;let i=$(e);var s=i.slick({autoplay:!0,nextArrow:!1,prevArrow:!1,autoplaySpeed:4e3,dots:!0});$(window).width()>700&&(i.find(".pre-title").addClass("animated fadeInUp"),i.find("h1").addClass("animated fadeInUp"),i.find(".subtitle").addClass("animated fadeInUp"),i.find(".button").addClass("animated fadeInUp"),i.find("video").length&&(i.find(".section-intro").length>1?i.find("video")[1].play():i.find("video")[0].play()),s.on("beforeChange",(function(t,e,s){i.find(".pre-title").removeClass("animated fadeInUp"),i.find("h1").removeClass("animated fadeInUp"),i.find(".subtitle").removeClass("animated fadeInUp"),i.find(".button").removeClass("animated fadeInUp"),$(e.$slides.get(s)).find("video").length>0&&($(e.$slides.get(s)).find("video").get(0).pause(),$(e.$slides.get(s)).find("video").get(0).currentTime=0)})),s.on("afterChange",(function(t,e,s){i.find(".slick-current.slick-active  .pre-title").addClass("animated fadeInUp"),i.find(".slick-current.slick-active  h1").addClass("animated fadeInUp"),i.find(".slick-current.slick-active  .subtitle").addClass("animated fadeInUp"),i.find(".slick-current.slick-active  .button").addClass("animated fadeInUp"),$(e.$slides.get(s)).find("video").length>0&&$(e.$slides.get(s)).find("video").get(0).play()})))})),$(".sl").slick({prevArrow:'<button type="button" class="slick-prev far fa-chevron-left">Previous</button>',nextArrow:'<button type="button" class="slick-next far fa-chevron-right">Next</button>',infinite:!0,slidesToShow:4,slidesToScroll:1,autoWidth:!0,responsive:[{breakpoint:1024,settings:{slidesToShow:2}},{breakpoint:768,settings:{centerMode:!1,speed:100,dots:!0,slidesToShow:1,slidesToScroll:1}}]}),$(".sl").on("afterChange",(function(t,e,i,s){$(".slick-slide").find(".thumbnail-info").removeClass("hovered"),$(".slick-current").find(".thumbnail-info").addClass("hovered")})),$(".sl-tours").slick({prevArrow:'<button type="button" class="slick-prev far fa-chevron-left">Previous</button>',nextArrow:'<button type="button" class="slick-next far fa-chevron-right">Next</button>',infinite:!0,slidesToShow:4,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:3,slidesToScroll:3}},{breakpoint:900,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:420,settings:{slidesToShow:1,slidesToScroll:1}}]}),$(".slick-slider-col-3").slick({prevArrow:'<button type="button" class="slick-prev far fa-chevron-left">Previous</button>',nextArrow:'<button type="button" class="slick-next far fa-chevron-right">Next</button>',infinite:!0,slidesToShow:3,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:2}},{breakpoint:768,settings:{centerMode:!1,slidesToShow:1,slidesToScroll:1}}]}),$(".slick-slider-col-4").slick({prevArrow:'<button type="button" class="slick-prev far fa-chevron-left">Previous</button>',nextArrow:'<button type="button" class="slick-next far fa-chevron-right">Next</button>',infinite:!0,slidesToShow:4,slidesToScroll:1,responsive:[{breakpoint:1024,settings:{slidesToShow:2}},{breakpoint:768,settings:{centerMode:!1,slidesToShow:1,slidesToScroll:1}}]}),$(".slick-slider-col-2").slick({prevArrow:'<button type="button" class="slick-prev far fa-chevron-left">Previous</button>',nextArrow:'<button type="button" class="slick-next far fa-chevron-right">Next</button>',infinite:!0,slidesToShow:2,slidesToScroll:1,responsive:[{breakpoint:768,settings:{slidesToShow:1,slidesToScroll:1}}]});var t=$(".slider-status-info");$(".slick-slider-3d").on("init reInit afterChange",(function(e,i,s,n){var o=(s||0)+1;t.text(o+"/"+i.slideCount)})),$(".slick-slider-3d .slider-for").slick({arrows:!1,fade:!0,adaptiveHeight:!0,slidesToShow:1,slidesToScroll:1,asNavFor:".slick-slider-3d .slider-nav"}),$(".slick-slider-3d .slider-nav").slick({prevArrow:'<button type="button" class="slick-prev far fa-arrow-circle-left">Previous</button>',nextArrow:'<button type="button" class="slick-next far fa-arrow-circle-right">Next</button>',slidesToShow:1,slidesToScroll:1,asNavFor:".slick-slider-3d .slider-for",customPaging:function(t,e){return t.slickCurrentSlide+"/"+(e+1)}}),ResponsiveHelper.addRange({"..768":{on:function(){$(".to-slider-on-mobile").slick({infinite:!1,slidesToShow:1,slidesToScroll:1})},off:function(){$(".to-slider-on-mobile").slick("unslick")}}}),$(".media-slider .slider-for").slick({prevArrow:'<button type="button" class="slick-prev far fa-chevron-left"></button>',nextArrow:'<button type="button" class="slick-next far fa-chevron-right"></button>',fade:!0,slidesToShow:1,slidesToScroll:1,asNavFor:".media-slider .slider-nav"}),$(".media-slider .slider-nav").slick({arrows:!1,slidesToShow:4,slidesToScroll:4,asNavFor:".media-slider .slider-for",focusOnSelect:!0,responsive:[{breakpoint:768,settings:{slidesToShow:3,slidesToScroll:3}}]})}function initIsotope(){ResponsiveHelper.addRange({"1500..":{on:function(){$(".isotope-grid").isotope({itemSelector:".isotope-item",layoutMode:"masonry",percentPosition:!0,masonry:{columnWidth:".grid-sizer"}})},off:function(){$(".isotope-grid").isotope("destroy")}}})}
/*!
 ...
 */function initCustomForms(){jcf.setOptions("Select",{wrapNative:!1,fakeDropInBody:!1}),jcf.replaceAll(),jcf.destroy('.flatpickr-monthDropdown-months')}
/*!
 ...
 *
 * Version: 1.1.3
 */function initMobileNav(){jQuery("body").mobileNav({menuActiveClass:"nav-active",menuOpener:".nav-opener",hideOnClickOutside:!0,menuDrop:".mobile-menu-holder"})}function initPopups(){ResponsiveHelper.addRange({"..768":{on:function(){jQuery(".popup-holder").contentPopup({mode:"click",btnOpen:".popup-opener"})},off:function(){jQuery(".popup-holder").contentPopup("destroy")}}}),jQuery(".booking-popup-holder").contentPopup({mode:"click",btnOpen:".popup-opener"}),jQuery(".info-popup").contentPopup({mode:"click",btnOpen:".popup-opener",popup:".popup-holder"})}$(".pin").click((function(){show_map_info($(this))})),$(document).click((function(t){var e=t.target;$(e).is(".map__block")||$(e).parents().is(".map__block")||tooltip.hasClass("open")&&(tooltip.removeClass("open"),$(".map .active").removeClass("selected"))})),$(".map__tooltip__close").click((function(){tooltip.removeClass("open"),$(".map .active").removeClass("selected")})),jQuery(window).on("load",(function(){initSlick(),initIsotope(),initPopups(),initMobileNav(),initFitVids(),initAnchors(),initJqueryUI(),initFancyBox(),initCustomForms(),$(document).on("mouseover",".main-nav-drop>ul>li",(function(){$(".main-nav-drop>ul>li").removeClass("active"),$(this).addClass("active")})),$(".section-map").length&&$(".section-map").map((function(){id=$(".map-aside ul li:first a",this).data("poi-id"),id&&gmap($(".map-holder",this).attr("id"),$map_json_data[id])})),$("#desktop-nav > .nav > li > a").click((function(t){var e=$(this).parent().find(".sub-menu");if(e.length){t.preventDefault();var i=e.hasClass("open");$("#desktop-nav .sub-menu.open").removeClass("open"),i?e.removeClass("open"):e.addClass("open"),$(".search-popup-opener").find(".icon").removeClass("fa-times").addClass("fa-search"),$(".search-popup-opener").removeClass("opened_opened"),$(".search-popup-holder .popups").fadeOut()}})),$(".custom_picker").datepicker();var t="dd/mm/yy",e=$("#from").datepicker({changeMonth:!1,dateFormat:t,minDate:0,showOtherMonths:!0}).on("change",(function(){i.datepicker("option","minDate",getDate(this))})),i=$("#to").datepicker({changeMonth:!1,dateFormat:t,minDate:0,showOtherMonths:!0}).on("change",(function(){e.datepicker("option","maxDate",getDate(this))}));(window,document,"script","dataLayer")})),document.tidioChatLang=document.querySelector("html").getAttribute("lang"),window.tidioChatApi?window.tidioChatApi.on("ready",onTidioChatApiReady):document.addEventListener("tidioChat-ready",onTidioChatApiReady),document.querySelector(".chat-bot")&&document.querySelector(".chat-bot").addEventListener("click",(function(){window.tidioChatApi.show(),window.tidioChatApi.open(),$(".chat-bot").hide()})),function(t){"function"==typeof define&&define.amd?define(["jquery"],t):t(jQuery)}((function(t){t.ui=t.ui||{};t.ui.version="1.12.1";
    /*!
